...
const showResult2D = (title, containerId, dataArray) => {
    ...
    if(dataArray.length == 0){
        ...
        errorMessage.textContent = "The array's you provided are of invalid dimensions to perform the requested action.";
